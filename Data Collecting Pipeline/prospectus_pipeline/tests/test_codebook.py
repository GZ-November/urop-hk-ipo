...
class CodebookTests(unittest.TestCase):
    def test_build_codebook_full_coverage(self):
        ...
        self.assertEqual(summary["variable_count"], 138)
        self.assertEqual(summary["tiers"]["green_hkex"], 11)
        self.assertEqual(summary["tiers"]["blue_prospectus"], 77)
        self.assertEqual(summary["tiers"]["darkblue_external"], 50)
        self.assertEqual(len(variables), 138)
    ...
    def test_clean_csv_export(self):
        ...
        with open(csv_path, mode="r", encoding="utf-8-sig") as f:
            ...
            self.assertEqual(len(reader[0]), 138)
    ...
    def test_export_all_artifacts(self):
        res = export_all()
        self.assertEqual(res["variable_count"], 138)
        ...
        self.assertIn("138 维全量变量字典详细清单", md_content)
